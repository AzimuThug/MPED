...
data_jpg = IN_OUT.readXCR("./c12-85v_1Kx1K.xcr")
data_jpg = np.reshape(data_jpg, (1024, 1024))
...
print('2')
img_3 = Proccessing.gamma_transform(img_3, 1, 0.5)
print('3')
img_4 = Proccessing.gamma_transform(img_4, 2, 0.5)
print('4')
img_HollywoodLC = Proccessing.gamma_transform(img_HollywoodLC, 2, 0.5)
print('5')

# Логарифмическое преобразование
# img_1 = Proccessing.log_transform(img_1, 2)
# print('1')
...
# print('4')
# img_HollywoodLC = Proccessing.log_transform(img_HollywoodLC, 2)
# print('5')
