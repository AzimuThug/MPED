...
img_resize_1_3_NI = Proccessing.resize(img_source, 1.3, 1)
img_resize_1_3_BLI = Proccessing.resize(img_source, 1.3, 2)
img_resize_0_7 = Proccessing.resize(img_source, 0.7, 1)

IN_OUT.showJPG(path, img_resize_1_3_BLI)
IN_OUT.showJPG(path, img_resize_1_3_NI)
IN_OUT.showJPG(path, img_resize_0_7)

data = IN_OUT.readXCR("./c12-85v_1Kx1K.xcr")
data = np.reshape(data, (1024, 1024))
data = np.rot90(data)
data = Proccessing.resize(data, 4, 1)
